...
<div class="wrapper" id="profile">
    <div class="menu">
        <button name="profileBtn" onclick="location.href = 'profile.jsp'">Profile</button>
        <button name="tokenBtn" onclick="location.href = 'profile.jsp?showToken=true'">Token</button>
